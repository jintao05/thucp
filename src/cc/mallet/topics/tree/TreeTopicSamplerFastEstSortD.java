...
public class TreeTopicSamplerFastEstSortD extends TreeTopicSamplerSortD{
	...
	public void write (File serializedModelFile) {
		try {
			...
			System.err.println("Problem serializing TreeTopicSamplerFastEstSortD to file " +
							   serializedModelFile + ": " + e);
		}
	}

	public static TreeTopicSamplerFastEstSortD read (File f) throws Exception {

		TreeTopicSamplerFastEstSortD topicModel = null;

		ObjectInputStream ois = new ObjectInputStream (new FileInputStream(f));
		topicModel = (TreeTopicSamplerFastEstSortD) ois.readObject();
		ois.close();
